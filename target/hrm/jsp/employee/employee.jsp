...
<%@ taglib uri="http://yyf.pager-tags" prefix="yyf"%>
	    		   ...
	    		   if(checkedBoxs.length < 1){
	    			   ...
	    			   $.ligerDialog.confirm("确认要删除吗?","删除员工",function(r){
	    				   if(r){
							   ...
							   $.get("${pageContext.request.contextPath}/employee/removeEmployee?ids=" + ids.get(),function (data) {
								   if(data=="OK"){
								   	alert("删除成功！");
	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
	  ...
	  <tr valign="top"><td align="center" class="font3">
		  <yyf:pager pageIndex="${pageModel.pageIndex}"
					  ...
					  submitUrl="${pageContext.request.contextPath}/employee/findEmployee?pageIndex={0}&dept_id=${employee.dept.id}
                                    &name=${employee.name}&card_id=${employee.card_id}&phone=${employee.phone}&sex=${employee.sex}&job_id=${employee.job.id}"/>
<%--	  	 <fkjava:pager--%>
